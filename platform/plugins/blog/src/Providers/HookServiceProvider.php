            ...
            ->setSection([
                ...
                'fields' => [
                    [
                        ...
                        'attributes' => [
                            'name' => 'video_page_id',
                            'list' => ['' => trans('plugins/video::base.select')] + $pages,
                            'value' => '',
                            'options' => [
                                'class' => 'form-control',
                            ],
                    ...
                    [
                        'id' => 'number_of_video_in_a_category',
                        'type' => 'number',
                        'label' => trans('plugins/video::base.number_posts_per_page_in_category'),
                        'attributes' => [
                            'name' => 'number_of_video_in_a_category',
                            'value' => 12,
                            'options' => [
                                'class' => 'form-control',
                            ],
                    ...
                    [
                        'id' => 'number_of_video_in_a_tag',
                        'type' => 'number',
                        'label' => trans('plugins/video::base.number_video_per_page_in_tag'),
                        'attributes' => [
                            'name' => 'number_of_video_in_a_tag',
                            'value' => 12,
                            'options' => [
                                'class' => 'form-control',
                            ],
