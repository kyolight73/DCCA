...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/ripple/plugins/owl-carousel/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
    {!! BaseHelper::googleFonts(
        'https://fonts.googleapis.com/css2?family=' . urlencode(theme_option('primary_font', 'Roboto')) . '&display=swap',
    ) !!}
                ...
                <nav class="nav-top">
                    <div class="container">
                        <div class="row">
                            @if (theme_option('social_links'))
                                <div class="col-md-6">
                                    <div class="info">
                                        <ul>
                                            <li>
                                                <img src="https://labartisan.net/demo/constol/assets/images/header/icon/01.png"
                                                    alt="icon">
                                                <span>240 Parkway United States</span>
                                            </li>
                                            <li>
                                                <img src="https://labartisan.net/demo/constol/assets/images/header/icon/02.png"
                                                    alt="icon">
                                                <span>Mon-Fri : 09:30 Am - 06:24 Pm</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="hi-icon-wrap hi-icon-effect-3 hi-icon-effect-3a d-inline-block d-none">
                                        @foreach (json_decode(theme_option('social_links'), true) as $socialLink)
                                            @if (count($socialLink) == 3)
                                                <a href="{{ $socialLink[2]['value'] }}"
                                                    title="{{ $socialLink[0]['value'] }}"
                                                    class="hi-icon {{ $socialLink[1]['value'] }}" target="_blank">
                                                </a>
                                            @endif
                                        @endforeach
                                    </div>
                            ...
                            @endif
                            <div class="col-md-6 d-flex align-center justify-content-end">
                                    ...
                                    <ul class="d-flex d-none">
                                        @if (auth('member')->check())
                                            ...
                                            <li><a href="#"
                                                    ...
                                                    rel="nofollow"><i class="fa fa-sign-out"></i>
                                                    {{ __('Logout') }}</a></li>
                                        @else
                                ...
                                <div class="language-wrapper d-inline-block d-none">
                ...
                <div class="page-header__right">
                    ...
                    <div class="pull-left">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <a href="/lien-he" class="lab-btn">Liên hệ ngay</a>
                            </div>
                        </div>
